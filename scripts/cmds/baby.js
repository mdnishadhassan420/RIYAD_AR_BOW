...
const baseApiUrl = async () => {
  const res = await axios.get("https://raw.githubusercontent.com/sayem-dev-xs/second-baby-apixs/main/baseApiUrl.json");
...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    try {
      const BaseApiUrl = await baseApiUrl();
